...
*/
	...
	if (!NET_IsLocalAddress(from))
	{
		...
		// first connection attempt after challenge, save ping
        if ( !challengeptr->connectionTime )
		{
            challengeptr->connectionTime = svs.time;
		}

        ping = challengeptr->connectionTime - challengeptr->pingTime;
